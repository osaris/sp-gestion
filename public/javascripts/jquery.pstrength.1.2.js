(function (A) {
    A.extend(A.fn, {
        pstrength: function (B) {
            var B = A.extend({
                verdects: ["Très faible", "Faible", "Moyen", "Fort", "Très fort"],
                colors: ["#f00", "#c06", "#f60", "#3c0", "#3f0"],
                scores: [10, 15, 30, 40],
                common: ["motdepasse", "azerty", "test", "123456"],
                minchar: 6
            },
            B);
            return this.each(function () {
                ...
                A(this).after("<div class=\"pstrength-bar\" id=\"" + C + "_bar\" style=\"border: 1px solid white; font-size: 1px; height: 5px; width: 0px; margin-top:3px;\"></div>");
